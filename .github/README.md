...
[`@aws-sdk/client-license-manager`](https://www.npmjs.com/package/@aws-sdk/client-license-manager/v/3.1133.0).
...
- @aws-sdk/client-license-manager v3.1133.0 - [https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1133.0](https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1133.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1133.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5vnBgWpAOXAmEBHKIeO5PWWCHPObID17IGkDugHaSZfcqwx2V3dioZt8OCaoR/dM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-license-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1133.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1133.0/index.min.mjs": "sha384-5vnBgWpAOXAmEBHKIeO5PWWCHPObID17IGkDugHaSZfcqwx2V3dioZt8OCaoR/dM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-license-manager/blob/refs/tags/3.1133.0/LICENSE
```
