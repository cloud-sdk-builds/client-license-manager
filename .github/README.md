...
[`@aws-sdk/client-license-manager`](https://www.npmjs.com/package/@aws-sdk/client-license-manager/v/3.1094.0).
...
- @aws-sdk/client-license-manager - [https://cloud-sdk-builds.github.io/?sdk=client-license-manager](https://cloud-sdk-builds.github.io/?sdk=client-license-manager)
- @aws-sdk/client-license-manager v3.1094.0 - [https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1094.0](https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1094.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1094.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eyUOIocMOUHgnhleR3CBxBG7y3AQWw5x9UMVQVhhEe+Hw8ULpbSmB1hDi0VMEW+8
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-license-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1094.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1094.0/index.min.mjs": "sha384-eyUOIocMOUHgnhleR3CBxBG7y3AQWw5x9UMVQVhhEe+Hw8ULpbSmB1hDi0VMEW+8"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-license-manager";
...
```
https://github.com/cloud-sdk-builds/client-license-manager/blob/refs/tags/3.1094.0/LICENSE
```
