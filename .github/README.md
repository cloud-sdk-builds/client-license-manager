...
[`@aws-sdk/client-license-manager`](https://www.npmjs.com/package/@aws-sdk/client-license-manager/v/3.1054.0).
...
- @aws-sdk/client-license-manager v3.1054.0 - [https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1054.0](https://cloud-sdk-builds.github.io/?sdk=client-license-manager&version=3.1054.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1054.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+gvdps1nrJz9orkXFw6PBJJXPKNSilmKFvc6jRloO4CvedxdoEyDv3ZWhn/Cnt03
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-license-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1054.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.1054.0/index.min.mjs": "sha384-+gvdps1nrJz9orkXFw6PBJJXPKNSilmKFvc6jRloO4CvedxdoEyDv3ZWhn/Cnt03"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-license-manager/blob/refs/tags/3.1054.0/LICENSE
```
