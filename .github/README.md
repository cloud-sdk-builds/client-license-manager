...
[`@aws-sdk/client-license-manager`](https://www.npmjs.com/package/@aws-sdk/client-license-manager/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NkO2Pr2XOMsrCJWxVVAuo8HOPnT7ivMPvpIO40xmNRShq+yci3CZSNPeAOpL2pEu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-license-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.974.0/index.min.mjs": "sha384-NkO2Pr2XOMsrCJWxVVAuo8HOPnT7ivMPvpIO40xmNRShq+yci3CZSNPeAOpL2pEu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-license-manager/blob/refs/tags/3.974.0/LICENSE
```
