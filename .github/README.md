...
[`@aws-sdk/client-license-manager`](https://www.npmjs.com/package/@aws-sdk/client-license-manager/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wDRZEYJdNGjStVKSTll5PKomZf2XmW7vi2UslSdH2un6E4rfR5/Uh2rEYndcI1MD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-license-manager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-license-manager@3.730.0/index.min.mjs": "sha384-wDRZEYJdNGjStVKSTll5PKomZf2XmW7vi2UslSdH2un6E4rfR5/Uh2rEYndcI1MD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-license-manager/blob/refs/tags/3.730.0/LICENSE
```
